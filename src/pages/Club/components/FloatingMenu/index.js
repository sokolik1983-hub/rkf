...
const FloatingMenu = ({ alias, name, profileId, isFederation }) => {
    ...
    return <div className="FloatingMenu__wrap">
        ...
        >
            ...
            {presidium[alias] &&
                <DropDownItem>
                    <Link to="/" onClick={getPresidium} className="FloatingMenu__link" title="Президиум">Президиум</Link>
                </DropDownItem>
            }
            <DropDownItem>
            ...
            {alias === 'rfls' && <>
                <DropDownItem>
                    <Link to="/" onClick={getFees} className="FloatingMenu__link" title="Размеры членских взносов">
                        Размеры членских взносов
                        </Link>
                </DropDownItem>
                <DropDownItem>
                    <Link to="/" onClick={getBlanks} className="FloatingMenu__link" title="Бланки">
                        Бланки
                        </Link>
                </DropDownItem>
                <DropDownItem>
                    <Link to="/" onClick={getRequisites} className="FloatingMenu__link" title="Реквизиты">
                        Реквизиты
                        </Link>
                </DropDownItem>
            </>}
