...
const SearchCard = ({handleActiveReset, setCardClicked, userType, isAuthenticated}) => (
    <Card className='bs-menu-component__card'>
        <h3 className='bs-menu-component__title'>Поиск</h3>
        <ul className='bs-menu-component__list'>
            <li className='bs-menu-component__item'>
                <LinkScroll
                    ...
                    offset={-80}
                    duration={200}
                    className='bs-menu-component__link'
                ...
                >
                    <span className='bs-menu-component__icon'>
            ...
            <li className='bs-menu-component__item menu-component__item--judge'>
                <LinkScroll
