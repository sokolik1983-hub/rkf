                ...
                <div>
                    {
                        isMobile ? (
                            ...
                            <HorizontalSwipe id="search-page__list-filter" desktopScroll={true}>
                                <ul className="list-filter">
                                    ...
                                    <li className="list-filter__item">
                                        ...
                                        >
                                <span
                                    className="list-filter__control">Информация о найденных собаках</span>
                                        </LinkScroll>
                                    ...
                                    <li className="list-filter__item">
                                        ...
                                        >
                                            <span className="list-filter__control">Регистрационные данные собаки</span>
                                        </LinkScroll>
                                    ...
                                    <li className="list-filter__item">
                                        ...
                                        >
                                            <span className="list-filter__control">Поиск клуба/питомника по клейму</span>
                                        </LinkScroll>
                                    ...
                                    <li  className="list-filter__item">
                                        ...
                                        >
                                            <span className="list-filter__control">Поиск по объявлениям</span>
                                        </LinkScroll>
