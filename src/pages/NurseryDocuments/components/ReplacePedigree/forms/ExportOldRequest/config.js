...
const config = {
    ...
    url: '/api/requests/replace_pedigree_request/nurseryreplacepedigreeexportoldrequest',
    get: '/api/requests/replace_pedigree_request/nurseryreplacepedigreeexportoldrequest',
    initialValues: {
        federation_id: '',
        declarant_id: '',
        express: false,
