...
<Title/>
    ...
    <div className="stage-controls flex-row">
            <Button className="btn-condensed" onClick={e => window.confirm("Не сохраненные данные будут утеряны, вы уверены что хотите вернуться?") && setRedirect(`/kennel/${alias}/documents/litter/${formik.values.litter_request_id}/table/form`)}>Назад</Button>
        <SubmitError />
