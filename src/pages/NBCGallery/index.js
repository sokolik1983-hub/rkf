...
const NBCGallery = ({ isAuthenticated, is_active_profile, profile_id, match, user }) => {
    ...
    const Breadcrumbs = () => {
        return <div className="NBCGallery__breadcrumbs">
            <div className="NBCGallery__breadcrumbs-title">
        ...
        <>
            {
                loading ?
                    ...
                    <NBCLayout>
                        <Card>
                            <Breadcrumbs />
                            <div className="NBCGallery__buttons">
                                {album && canEdit && <Link className="NBCGallery__buttons-link" to={`/nbc/${alias}/gallery/${params.album}/edit`}>
                                    <div className="NBCGallery__buttons-link__icon">
                                ...
                                {album && canEdit && album.addition && <>
                                                    <span className="NBCGallery__buttons-link" onClick={() => handleAlbumDelete(params.album)}>
                                                        <div className="NBCGallery__buttons-link__icon">
                                    ...
                                    <span className="NBCGallery__buttons-link" onClick={() => handleAddPhoto()}>
                                                        <div className="NBCGallery__buttons-link__icon">
                            ...
                            {!pageLoaded ?
                                ...
                                <InfiniteScroll
                                    ...
                                    endMessage={!images.length &&
                                        <div className="NBCGallery__no-images">
