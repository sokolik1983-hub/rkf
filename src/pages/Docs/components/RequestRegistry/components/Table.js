                    ...
                    </div>
                    {
                        documents && distinction === 'litter'
                            ? <><Grid
                                ...
                                {...gridData}
                                onDataStateChange={handleGridDataChange}
                                style={{ height: height ? height : "750px", maxWidth: `${fullScreen ? `auto` : `1035px`}`, margin: "0 auto", textAlign: 'center' }}>
                                ...
                                <GridColumn field="date_change" title="Изменение статуса" width={fullScreen ? 'auto' : '80px'} columnMenu={ColumnMenu} cell={props => DateCell(props, 'date_change')} />
                                <GridColumn field="breed" title="Порода" width={fullScreen ? 'auto' : '80px'} columnMenu={ColumnMenu} />
                                <GridColumn field="stamp_code" title="Клеймо" width={fullScreen ? '88px' : '55px'} columnMenu={ColumnMenu} />
                                <GridColumn field="nursery_name" title="Питомник" width={fullScreen ? 'auto' : '80px'} columnMenu={ColumnMenu} />
                                <GridColumn field="date_of_birth_litter" title="Дата рождения помёта" width={fullScreen ? 'auto' : '80px'} columnMenu={ColumnMenu} cell={props => DateCell(props, 'date_of_birth_litter')} />
                                <GridColumn field="breeder_full_name" title="Заводчик" width={fullScreen ? 'auto' : '80px'} columnMenu={ColumnMenu} />
                                ...
                                <GridColumn field="dog_father_name" title="Производитель (кличка)" width={fullScreen ? 'auto' : '104px'} columnMenu={ColumnMenu} />
                                <GridColumn field="dog_mother_name" title="Производительница (кличка)" width={fullScreen ? 'auto' : '104px'} columnMenu={ColumnMenu} />
                            </Grid>
                                <GridPDFExport
