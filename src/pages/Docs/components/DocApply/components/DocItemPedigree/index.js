        ...
        <HideIf cond={false}>
            <div className={`DocItem`}>
                ...
                <FormGroup className="card">
                    ...
                    <FormGroup inline className="stampCodeNumber">
                        <FormField disabled={update || !!everkData} placeholder="XXX" fieldType="reactSelectCreatable" options={stampCodes} name={`stamp_code_name`} label={`Код клейма (<a href="/${alias}/documents/stamps/add">Добавить клеймо</a>)`} onChange={e => formik.setFieldValue(`stamp_code_name`, e.toUpperCase())} />
                    ...
                    <FormGroup inline className="emailAndAddress">
                    ...
                    <FormGroup inline className="breed_name">
                    ...
                    <FormGroup inline className="threeColumnInline">
                        <div className="DocItem__pedigree-calendar-wrap">
                            ...
                            <UserDatePicker
                                ...
                                className="DocItem__pedigree-calendar"
                                disabled={update}
                            />
                        </div>
                    ...
                    <FormGroup inline className="twoColumnInline">
                    ...
                    <FormGroup inline className="twoColumnInlineFiles">
                        <FormFile
