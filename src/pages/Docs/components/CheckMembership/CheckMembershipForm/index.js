        ...
        <div className="application-form">
            <Card>
                <div className="club-documents-status__head">
                    <Link to={`/${clubAlias}/documents/responsible`} className="club-documents-status__head-link">Личный кабинет</Link>
                    &nbsp;/&nbsp;
                                ...
                                return (
                                    <FormElement>
                                        ...
                                        <div className="application-form__content">
                                            ...
                                            {status === 'edit' && <div style={{ marginTop: '20px' }}>
                                                ...
                                                <div className="application-form__row">
                                                    {/* <div>
                                                        <DropDownList
                                                            ...
                                                            defaultItem={{ name_rus: "Тип документа", id: 0 }}
                                                        />
                                                    </div> */}
                                                    <div>
                                                        <Field
                                                            ...
                                                            saveField="document"
                                                            multiple={true}
                                                            onAdd={e => onAdd(e, 'documents')}
                                                            onRemove={e => onRemove(e, 'documents')}
