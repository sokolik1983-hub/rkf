            ...
            <IntlProvider locale="ru">
                ...
                {filteredDocuments && <>
                    ...
                    <Grid
                        ...
                        <GridColumn field="owner_name" title="ФИО владельца" width={fullScreen ? 'auto' : '127px'} columnMenu={ColumnMenu} />
                        <GridColumn field="dog_name" title="Кличка" width={fullScreen ? 'auto' : '119px'} columnMenu={ColumnMenu} />
                        <GridColumn field="breed_name" title="Порода" width={fullScreen ? 'auto' : '126px'} columnMenu={ColumnMenu} cell={props => TextCell(props, 'breed_name')} />
