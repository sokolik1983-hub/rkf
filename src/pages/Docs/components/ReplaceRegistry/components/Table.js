            ...
            <IntlProvider locale={'ru'}>
                ...
                </StickyFilters>
                {
                    documents && <><Grid
                        ...
                        {...gridData}
                        onDataStateChange={handleGridDataChange}
                        style={{ height: "700px", maxWidth: `${fullScreen ? `1100px` : `810px`}`, margin: "0 auto" }}>
                        <GridColumn field="date_create" title="Дата создания" width={fullScreen ? '120px' : '80px'} columnMenu={ColumnMenu} cell={props => DateCell(props, 'date_create')} />
