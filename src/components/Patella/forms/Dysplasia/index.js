...
const FormFields = connect(({ formik, update, view, options, alias, setRedirect, send, initial, Title, config }) => {
    ...
    return <>
        ...
        <Card className="dysplasiaApplication">
            ...
            <FormGroup inline className="xray_agreement">
                <FormFile
            ...
            <FormGroup inline className="pedigree_agreement">
                <FormFile
            ...
            <FormGroup>
                ...
                <HideIf cond={formik.values.cash_payment}>
                    ...
                    <FormGroup inline className="payment_receipt">
                        <FormFile
                    ...
                    <FormGroup inline className="dyspName">
