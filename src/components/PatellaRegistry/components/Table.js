...
const OptionsCell = ({ dataItem }, profileType, setErrorReport) => {
    ...
    const { type_id, status_id, id, date_archive } = dataItem;
                ...
                <IntlProvider locale={'ru'}>
                    ...
                    {filteredDocuments && <><div className="archive-notification"><p className="archive-notification__title">Уважаемые пользователи!</p>
                        ...
                        <Grid
                            ...
                            <GridColumn width={fullScreen ? '100px' : '70px'} title="Опции" cell={props => OptionsCell(props, profileType, setErrorReport)} />
                            ...
                            <GridColumn field="dog_name" title="Кличка" width={fullScreen ? 'auto' : '189px'} columnMenu={ColumnMenu} />
