...
const clientExhibitionContestStateInitialState = {
    loadingApi: false,
    days: {},
    items: {},
    dateIds: [],
...
const clientExhibitionContestReducer = createReducer(clientExhibitionContestStateInitialState, {
...
export default clientExhibitionContestReducer;