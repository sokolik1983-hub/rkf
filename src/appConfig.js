...
const mainNavIcons = [
    {
        ...
        to: '/organizations',
        exact: true,
        imageSrc: "/static/images/header/organizations.png",
    },
    {
        id: 2,
        title: "Календарь мероприятий",
        to: '/exhibitions',
        exact: false,
        imageSrc: "/static/images/header/calendar.png",
    },
    {
        id: 3,
        title: "Специалисты",
        to: '/',
        exact: true,
        imageSrc: "/static/images/header/experts.png",
    },
    {
        id: 4,
        ...
        to: '/search',
        exact: true,
        imageSrc: "/static/images/header/search.png",
    },
    {
        id: 5,
        title: "O RKF.Online",
        to: '/about',
        exact: false,
        imageSrc: "/static/images/header/about.png",
    }
];
