...
const footerNav = [
    {
        ...
        image: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M21 11L11 2L1 11" stroke="#90999E" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
            <path d="M3 9.5V21H8.33333V13.9286H13.6667V21H19V9.5" stroke="#90999E" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
        </svg>
    },

    {
        ...
        image:  <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 1.86957L21 14.913C21 15.3913 20.6087 15.7826 20.1304 15.7826H6.21739L1 19.2609V15.7826L1 1.86957C1 1.3913 1.39131 1 1.86957 1H20.1304C20.6087 1 21 1.3913 21 1.86957Z" stroke="#90999E" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
                </svg>
    },
    {
        id: 3,
        ...
        to: '',
        image: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z" stroke="#979797" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
                <path d="M4.18259 18.3131C5.29563 15.8087 7.93041 14.0435 11 14.0435C14.0695 14.0435 16.7043 15.8087 17.8174 18.3131" stroke="#979797" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
                <path d="M11 11.7217C13.0795 11.7217 14.7652 10.036 14.7652 7.95653C14.7652 5.87706 13.0795 4.19131 11 4.19131C8.92051 4.19131 7.23477 5.87706 7.23477 7.95653C7.23477 10.036 8.92051 11.7217 11 11.7217Z" stroke="#979797" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round" strokeLinejoin="round"/>
            </svg>
    ...
    },
    {
        ...
        exact: false,
        image: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.6608 4.82128V2.66961C17.6608 1.7525 16.92 1 15.9912 1H2.66961C1.74074 1 1 1.74074 1 2.66961V19.3304C1 20.2475 1.74074 21 2.66961 21H16.0029C16.92 21 17.6725 20.2593 17.6725 19.3304V10.1123" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M10.5356 14.5215L13.0753 14.7096L19.7537 8.03118C20.4004 7.3845 20.4004 6.3263 19.7537 5.67962L19.3775 5.30337C18.7308 4.65669 17.6726 4.65669 17.0259 5.30337L10.3475 11.9818L10.5356 14.5215Z" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M4.57434 4.82129H13.9806" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M4.57434 8.38391H13.522" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M4.57434 11.9465H10.3474" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M4.57434 15.5092H8.24277" stroke="#8F989D" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
            </svg>
    ...
    },
    {
        ...
        exact: false,
        image: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.7096 17.7255L20.6898 11.7367C20.7846 11.6419 20.8621 11.5213 20.9138 11.392C20.9655 11.2628 20.9914 11.1249 20.9914 10.987C20.9914 10.8491 20.9655 10.7113 20.9138 10.582C20.8621 10.4528 20.7846 10.3407 20.6898 10.2373L14.7096 4.24854" stroke="#90999E" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M5.75659 10.9956H21" stroke="#90999E" strokeWidth="1.32" strokeMiterlimit="10" strokeLinejoin="round"/>
                <path d="M21 6.56657V2.99052C21 2.72339 20.9483 2.4735 20.8449 2.23223C20.7415 1.99095 20.6036 1.77553 20.414 1.58595C20.2245 1.39638 20.009 1.25851 19.7678 1.15511C19.5265 1.0517 19.268 1 19.0095 1H2.99052C2.72339 1 2.4735 1.0517 2.23223 1.15511C1.98234 1.24989 1.76691 1.39638 1.58595 1.58595C1.39638 1.76691 1.24989 1.98234 1.15511 2.23223C1.06032 2.48212 1 2.72339 1 2.99052V19.0095C1 19.2766 1.0517 19.5265 1.15511 19.7678C1.25851 20.009 1.39638 20.2245 1.58595 20.414C1.77553 20.6036 1.99095 20.7415 2.23223 20.8449C2.4735 20.9483 2.73201 21 2.99052 21H19.0095C19.2766 21 19.5265 20.9483 19.7678 20.8449C20.009 20.7415 20.2245 20.6036 20.414 20.414C20.6036 20.2245 20.7415 20.009 20.8449 19.7678C20.9483 19.5265 21 19.268 21 19.0095V15.4334" stroke="#90999E" strokeWidth="1.32" strokeLinejoin="round" strokeLinejoin="round"/>
            </svg>
