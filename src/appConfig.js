...
const footerNav = [
    {
        ...
        image: <svg width='22' height='21' viewBox='0 0 22 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path d='M21 10L11 1L1 10' stroke='#90999E' strokeWidth='1.32' strokeMiterlimit='10' strokeLinecap='round'
                  strokeLinejoin='round' />
            <path d='M3 8.5V20H8.33333V12.9286H13.6667V20H19V8.5' stroke='#90999E' strokeWidth='1.32'
...

    {
        ...
        image: <svg width='22' height='20' viewBox='0 0 22 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
                ...
                stroke='#90999E' strokeWidth='1.32' strokeMiterlimit='10' strokeLinecap='round'
                strokeLinejoin='round' />
        </svg>
    ...
    },
    {
        ...
        disabled: true,
        exact: false,
        image: <svg width='25' height='25' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
                d='M17.9238 6.3894H7.11886C6.5516 6.3894 6.1059 6.83511 6.1059 7.40237C6.1059 7.96963 6.56511 8.41534 7.11886 8.41534H17.9238C18.4776 8.41534 18.9368 7.95612 18.9368 7.40237C18.9368 6.84862 18.4776 6.3894 17.9238 6.3894Z'
                fill='#8F989D' />
            <path
    ...
    },
    {
        ...
        disabled: false,
        exact: false,
        image: <svg id="Layer_1" className="login-link__icon" width="26" height="26" stroke="#90999e" data-name="Layer 1"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><path fill="none" strokeMiterlimit="10" strokeWidth="8px" d="M154.74,111.62l10.83,10.83a3.62,3.62,0,0,1,0,5.13L116.1,177.05a3.65,3.65,0,0,1-2.18,1l-12.13,1.29a3.64,3.64,0,0,1-4-4l1.29-12.13a3.6,3.6,0,0,1,1-2.18l49.47-49.47A3.62,3.62,0,0,1,154.74,111.62Z" />
                <line fill="none" strokeMiterlimit="10" strokeWidth="8px" x1="156.51" y1="136.65" x2="140.54" y2="120.68" /><circle fill="none" strokeMiterlimit="10" strokeWidth="8px" cx="100" cy="55.48" r="31.63" /><path fill="none" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="8px" d="M141.35,102.2a39.7,39.7,0,0,0-1.82-4c-8.16-14.85-70.9-14.85-79.06,0s-16.94,70.22-16.94,70.22" />
                </svg>
    },
];
